# Dldata Buffer Capability Spec

## Purpose

Exposes MCP tools for managing buffered downlink data items via the Sylvia-IoT coremgr/broker API. Covers count, listing, and deletion of buffered downlink data.
