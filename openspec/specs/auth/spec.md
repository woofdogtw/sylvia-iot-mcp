...
Exposes MCP tools for authentication and user profile management via the Sylvia-IoT auth and coremgr APIs. Covers token info retrieval, user profile read, and user profile update.
