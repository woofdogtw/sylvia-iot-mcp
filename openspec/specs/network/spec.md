# Network Capability Spec

## Purpose

Exposes MCP tools for managing networks via the Sylvia-IoT coremgr API. Covers network creation, count, listing, retrieval, update, deletion, queue statistics, and simulating device uplink data.
