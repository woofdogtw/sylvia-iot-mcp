# Device Route Capability Spec

## Purpose

Exposes MCP tools for managing device routes via the Sylvia-IoT coremgr/broker API. Covers single device route creation, bulk creation and deletion by address list and hex range, count, listing, and deletion.
