# Network Route Capability Spec

## Purpose

Exposes MCP tools for managing network routes via the Sylvia-IoT coremgr/broker API. Covers network route creation, count, listing, and deletion.
