# Device Capability Spec

## Purpose

Exposes MCP tools for managing devices via the Sylvia-IoT coremgr/broker API. Covers single device creation, bulk creation and deletion by address list and hex range, count, listing, retrieval, update, and deletion.
