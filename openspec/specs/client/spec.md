# Client Capability Spec

## Purpose

Exposes MCP tools for managing OAuth2 clients via the Sylvia-IoT coremgr API. Covers client creation, count, listing, retrieval, update, and deletion.
